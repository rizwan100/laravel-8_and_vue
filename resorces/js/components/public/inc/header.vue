<template>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="float-left">
              <p>Phone: +91 6281905305</p>
              <p>email: iammohammedrizwan1@gmail.com</p>
            </div>
          </div>
          <div class="col-lg-5">
    ...
    <div class="main_menu text-white">
      <!-- <div class="container"> -->
        <nav class="navbar navbar-expand-lg   navbar-dark w-100 px-100 bg-primary text-white ">
          <!-- Brand and toggle get grouped for better mobile display -->
          <a class="navbar-brand logo_h" href="/">
            <!-- <img  v-bind:src = "image" alt="Hyderabadi Cart" /> -->
          <a class="navbar-brand" href="/">  Hyderabadi Grocery</a>
