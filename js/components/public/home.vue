    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Rizwan Ecommerce </p>
            <h3><span>Grocery</span> To <br /> Your <span>Doorstep.</span></h3>
            <h4>An online platform for a busy and healthy life. </h4>
            <a class="main_btn mt-40" href="../#/category/1">View Collection</a>
          </div>
        </div>
      </div>
    </div>
